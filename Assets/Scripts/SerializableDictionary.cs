...
public class SerializableDictionary<TKey, TValue> : System.Collections.Generic.Dictionary<TKey, TValue>, ISerializationCallbackReceiver
{
    ...
    [SerializeField]
    private List<KeyValuePair<TKey, TValue>> keyValueList = new List<KeyValuePair<TKey, TValue>>(9);
    ...
    public void OnBeforeSerialize()
    {
        ...
        {
            keyValueList.Add(new KeyValuePair<TKey, TValue>());
            keys.Add(new KeyValuePair<TKey, TValue>().Key);
            values.Add(new KeyValuePair<TKey, TValue>().Value);
        }
...
[Serializable] public class DictionaryOfGameObjectandFloat : SerializableDictionary<GameObject, float> { }
////////////////////////////////
...
[CustomPropertyDrawer(typeof(DictionaryOfGameObjectandFloat))]
[Serializable] public class DictionaryOfGameObjectandFloatDrawer : DictionaryDrawer<string, float> { }

[Serializable] public class DictionaryOfGameObjectandFloat : SerializableDictionary<string, float> { }
*/